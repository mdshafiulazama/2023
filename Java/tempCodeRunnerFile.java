...
public class tempCodeRunnerFile {
    ...
    private static final String[] categories = {"Computer", "Electronics", "Electrical", "Civil", "Mechanical", "Architecture"};
    ...
    private static class Book {
        ...
        Book(int id, String stname, String name, String Author, int quantity, float Price, int count, int rackno, String cat, Date issued, Date duedate) {
            this.id = id;
            this.stname = stname;
            this.name = name;
            this.Author = Author;
    ...
    private static void addBooks() {
        ...
        Book book = new Book(currentBookId, "", name, author, quantity, price, 0, rackNo, category, issuedDate, dueDate);
        currentBookId++;
        books.add(book);
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(BOOKS_RECORD_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 11) {
                    ...
                    Book book = new Book(id, stname, name, author, quantity, price, count, rackno, cat, issuedDate, dueDate);
                    if (id >= currentBookId) {
                        currentBookId = id + 1;
                    }
                    books.add(book);
